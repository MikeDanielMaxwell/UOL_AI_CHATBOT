# Importing all Libraries needed for Tensorflow processing
import nltk
nltk.download("punkt")
...
# importing the intent file "intents.json" used for training the model.
with open("intents.json") as json_data: 
    intents = json.load(json_data)      # Loading data from intents.json file to var intents

# Creating a list that will be used for ignoring all unwanted punctuation marks.
ignore = ["?"]
